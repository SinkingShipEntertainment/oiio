...
function(_Boost_COMPONENT_HEADERS component _hdrs)
  ...
  set(_Boost_ATOMIC_HEADERS              "${BOOST_SUBDIR}/atomic.hpp")
  set(_Boost_CHRONO_HEADERS              "${BOOST_SUBDIR}/chrono.hpp")
  set(_Boost_CONTAINER_HEADERS           "${BOOST_SUBDIR}/container/container_fwd.hpp")
  set(_Boost_CONTRACT_HEADERS            "${BOOST_SUBDIR}/contract.hpp")
  if(Boost_VERSION_STRING VERSION_LESS 1.61.0)
    set(_Boost_CONTEXT_HEADERS           "${BOOST_SUBDIR}/context/all.hpp")
  else()
    set(_Boost_CONTEXT_HEADERS           "${BOOST_SUBDIR}/context/detail/fcontext.hpp")
  endif()
  set(_Boost_COROUTINE_HEADERS           "${BOOST_SUBDIR}/coroutine/all.hpp")
  set(_Boost_DATE_TIME_HEADERS           "${BOOST_SUBDIR}/date_time/date.hpp")
  set(_Boost_EXCEPTION_HEADERS           "${BOOST_SUBDIR}/exception/exception.hpp")
  set(_Boost_FIBER_HEADERS               "${BOOST_SUBDIR}/fiber/all.hpp")
  set(_Boost_FILESYSTEM_HEADERS          "${BOOST_SUBDIR}/filesystem/path.hpp")
  set(_Boost_GRAPH_HEADERS               "${BOOST_SUBDIR}/graph/adjacency_list.hpp")
  set(_Boost_GRAPH_PARALLEL_HEADERS      "${BOOST_SUBDIR}/graph/adjacency_list.hpp")
  set(_Boost_IOSTREAMS_HEADERS           "${BOOST_SUBDIR}/iostreams/stream.hpp")
  set(_Boost_LOCALE_HEADERS              "${BOOST_SUBDIR}/locale.hpp")
  set(_Boost_LOG_HEADERS                 "${BOOST_SUBDIR}/log/core.hpp")
  set(_Boost_LOG_SETUP_HEADERS           "${BOOST_SUBDIR}/log/detail/setup_config.hpp")
  set(_Boost_JSON_HEADERS                "${BOOST_SUBDIR}/json.hpp")
  set(_Boost_MATH_HEADERS                "${BOOST_SUBDIR}/math_fwd.hpp")
  set(_Boost_MATH_C99_HEADERS            "${BOOST_SUBDIR}/math/tr1.hpp")
  set(_Boost_MATH_C99F_HEADERS           "${BOOST_SUBDIR}/math/tr1.hpp")
  set(_Boost_MATH_C99L_HEADERS           "${BOOST_SUBDIR}/math/tr1.hpp")
  set(_Boost_MATH_TR1_HEADERS            "${BOOST_SUBDIR}/math/tr1.hpp")
  set(_Boost_MATH_TR1F_HEADERS           "${BOOST_SUBDIR}/math/tr1.hpp")
  set(_Boost_MATH_TR1L_HEADERS           "${BOOST_SUBDIR}/math/tr1.hpp")
  set(_Boost_MPI_HEADERS                 "${BOOST_SUBDIR}/mpi.hpp")
  set(_Boost_MPI_PYTHON_HEADERS          "${BOOST_SUBDIR}/mpi/python/config.hpp")
  set(_Boost_MYSQL_HEADERS               "${BOOST_SUBDIR}/mysql.hpp")
  set(_Boost_NUMPY_HEADERS               "${BOOST_SUBDIR}/python/numpy.hpp")
  set(_Boost_NOWIDE_HEADERS              "${BOOST_SUBDIR}/nowide/cstdlib.hpp")
  set(_Boost_PRG_EXEC_MONITOR_HEADERS    "${BOOST_SUBDIR}/test/prg_exec_monitor.hpp")
  set(_Boost_PROGRAM_OPTIONS_HEADERS     "${BOOST_SUBDIR}/program_options.hpp")
  set(_Boost_PYTHON_HEADERS              "${BOOST_SUBDIR}/python.hpp")
  set(_Boost_RANDOM_HEADERS              "${BOOST_SUBDIR}/random.hpp")
  set(_Boost_REGEX_HEADERS               "${BOOST_SUBDIR}/regex.hpp")
  set(_Boost_SERIALIZATION_HEADERS       "${BOOST_SUBDIR}/serialization/serialization.hpp")
  set(_Boost_SIGNALS_HEADERS             "${BOOST_SUBDIR}/signals.hpp")
  set(_Boost_STACKTRACE_ADDR2LINE_HEADERS "${BOOST_SUBDIR}/stacktrace.hpp")
  set(_Boost_STACKTRACE_BACKTRACE_HEADERS "${BOOST_SUBDIR}/stacktrace.hpp")
  set(_Boost_STACKTRACE_BASIC_HEADERS    "${BOOST_SUBDIR}/stacktrace.hpp")
  set(_Boost_STACKTRACE_NOOP_HEADERS     "${BOOST_SUBDIR}/stacktrace.hpp")
  set(_Boost_STACKTRACE_WINDBG_CACHED_HEADERS "${BOOST_SUBDIR}/stacktrace.hpp")
  set(_Boost_STACKTRACE_WINDBG_HEADERS   "${BOOST_SUBDIR}/stacktrace.hpp")
  set(_Boost_SYSTEM_HEADERS              "${BOOST_SUBDIR}/system/config.hpp")
  set(_Boost_TEST_EXEC_MONITOR_HEADERS   "${BOOST_SUBDIR}/test/test_exec_monitor.hpp")
  set(_Boost_THREAD_HEADERS              "${BOOST_SUBDIR}/thread.hpp")
  set(_Boost_TIMER_HEADERS               "${BOOST_SUBDIR}/timer.hpp")
  set(_Boost_TYPE_ERASURE_HEADERS        "${BOOST_SUBDIR}/type_erasure/config.hpp")
  set(_Boost_UNIT_TEST_FRAMEWORK_HEADERS "${BOOST_SUBDIR}/test/framework.hpp")
  set(_Boost_URL_HEADERS                 "${BOOST_SUBDIR}/url.hpp")
  set(_Boost_WAVE_HEADERS                "${BOOST_SUBDIR}/wave.hpp")
  set(_Boost_WSERIALIZATION_HEADERS      "${BOOST_SUBDIR}/archive/text_wiarchive.hpp")
  set(_Boost_BZIP2_HEADERS               "${BOOST_SUBDIR}/iostreams/filter/bzip2.hpp")
  set(_Boost_ZLIB_HEADERS                "${BOOST_SUBDIR}/iostreams/filter/zlib.hpp")
...
#########################################################
set(BOOST_SUBDIR boost)
if(DEFINED ENV{REZ_HOUDINI_ROOT})
  set(BOOST_SUBDIR hboost)
  set(Boost_DEFINITION "HBOOST")
  set(Boost_NAMESPACE "hboost")
  set(BOOST_LIBRARYDIR $ENV{HOUDINI_LOCATION}/dsolib)
  set(Boost_INCLUDE_DIR $ENV{HOUDINI_LOCATION}/toolkit/include)
  add_definitions(-DHBOOST)
endif()
#########################################################
...
if(Boost_INCLUDE_DIR)
  _Boost_DEBUG_PRINT("${CMAKE_CURRENT_LIST_FILE}" "${CMAKE_CURRENT_LIST_LINE}"
                     "location of version.hpp: ${Boost_INCLUDE_DIR}/${BOOST_SUBDIR}/version.hpp")

  # Extract Boost_VERSION_MACRO and Boost_LIB_VERSION from version.hpp
  set(Boost_VERSION_MACRO 0)
  set(Boost_LIB_VERSION "")
  file(STRINGS "${Boost_INCLUDE_DIR}/${BOOST_SUBDIR}/version.hpp" _boost_VERSION_HPP_CONTENTS REGEX "#define ${Boost_DEFINITION}_(LIB_)?VERSION ")
  if("${_boost_VERSION_HPP_CONTENTS}" MATCHES "#define ${Boost_DEFINITION}_VERSION ([0-9]+)")
    set(Boost_VERSION_MACRO "${CMAKE_MATCH_1}")
  endif()
  if("${_boost_VERSION_HPP_CONTENTS}" MATCHES "#define ${Boost_DEFINITION}_LIB_VERSION \"([0-9_]+)\"")
...
foreach(COMPONENT ${Boost_FIND_COMPONENTS})
  ...
  message("Boost_${UPPERCOMPONENT}_HEADER ----- ${Boost_${UPPERCOMPONENT}_HEADER}")
